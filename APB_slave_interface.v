...
wire [7:0]br_mask=8'b01110111; //reserved bits of cr2 with zeros other with ones
wire [7:0]cr2_mask=8'b00011011; //reserved bits of br with 0 else 1
...
always@(state,psel_i,penable_i,presetn)
begin
	//state=idle;
	case(state)
		idle:begin
...
always@(posedge pclk or negedge presetn)
begin
 //reserved bits of br with 0 else 1
